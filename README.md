# 👋 안녕하세요, 데이터와 AI로 가치의 연결고리를 만드는 함승훈입니다.


> 📧 **Email**: [seunghun5321@gmail.com](mailto:seunghun5321@gmail.com)

> **AI Engineer & Data Scientist**  
> "AI Engineer는 단순히 모델을 만드는 것을 넘어, 기술의 가능성을 현실의 가치로 변환하는 역할이라 생각합니다."
>
> 새로운 기술을 끊임없이 탐구하고 이를 적용하는 과정에서, 동료들과의 원활한 소통과 협력을 통해 프로젝트의 완성도를 높이는 데 주력하고 있습니다. 실무 환경에 맞춘 유연한 기술 적용 능력과 열린 소통을 바탕으로, 함께 성장하고 신뢰받는 AI Engineer가 되겠습니다.
